            ...
            <details className="text-sm">
              ...
              <div className="mt-3 space-y-4 select-none border rounded-lg p-4 bg-muted/30">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">채팅형 UI의 특성상, 사용자들은 주장과 논거를 체계적으로 전개하기보다는 가볍게 의견을 던지는 경향이 강했다. 채팅 인터페이스는 우리 일상에서 많이 쓰이는 형식이고 토론보다는 사담에 많이 이용하므로 익숙한 형태로 발화하기 때문이다. 인터페이스의 형태가 발화 내용을 생각보다 크게 좌지우지한다는 것을 알게 되었다.</p>
                </div>
              </div>
            </details>
            <Textarea
